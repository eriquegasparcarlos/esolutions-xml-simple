...
<Retention xmlns="urn:sunat:names:specification:ubl:peru:schema:xsd:Retention-1"
    ...
    <cac:ReceiverParty>
        <cac:PartyIdentification>
            <cbc:ID schemeID="{{ $document['supplier_identity_document_type_id'] }}">{{ $document['supplier_number'] }}</cbc:ID>
        </cac:PartyIdentification>
        <cac:PartyLegalEntity>
    ...
    <sac:SUNATTotalPaid currencyID="PEN">{{ $document['total_paid'] }}</sac:SUNATTotalPaid>
    ...
    <sac:SUNATRetentionDocumentReference>
        ...
        <sac:SUNATRetentionInformation>
            <sac:SUNATRetentionAmount currencyID="PEN">{{ $doc['retention_amount'] }}</sac:SUNATRetentionAmount>
            <sac:SUNATRetentionDate>{{ $doc['retention_date'] }}</sac:SUNATRetentionDate>
            <sac:SUNATNetTotalPaid currencyID="PEN">{{ $doc['net_total_paid'] }}</sac:SUNATNetTotalPaid>
