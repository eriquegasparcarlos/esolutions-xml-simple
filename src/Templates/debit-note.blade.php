...
<DebitNote xmlns="urn:oasis:names:specification:ubl:schema:xsd:DebitNote-2"
    ...
    {{-- En DebitNote el AllowanceCharge va ANTES de PaymentTerms (orden XSD, inverso a CreditNote) --}}
    ...
    @foreach($document['items'] as $line)
        <cac:DebitNoteLine>
            ...
            <cbc:DebitedQuantity unitCode="{{ $line['unit_type_id'] ?? '' }}"
                                  unitCodeListID="UN/ECE rec 20"
                                  unitCodeListAgencyName="United Nations Economic Commission for Europe">{{ $line['quantity'] }}</cbc:DebitedQuantity>
            ...
            {{-- Line taxes: en DebitNoteLine el TaxTotal va ANTES de AllowanceCharge (orden XSD, inverso a InvoiceLine) --}}
            <cac:TaxTotal>
