...
/*
 * Contrato de entrada para debit-note.blade.php (Nota de débito 08).
 * Documentación: docs/payloads/debit-note.md
 *
 * Igual que invoice, más el comprobante afectado y el motivo (catálogo 10);
 * sin date_of_due, prepayments, detraction, perception, retention ni
 * attributes de línea (la plantilla de ND no los emite).
 */
return [
    'required' => [
        'document',
